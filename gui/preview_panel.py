...
MEDIUM_SEVERITY_TYPES = {
    ...
    "NORWEGIAN_COMPANY", "NORWEGIAN_ORG_NUMBER", "NORWEGIAN_PHONE",
    "NORWEGIAN_POSTAL_ADDRESS", "NORWEGIAN_PASSPORT", "NORWEGIAN_VEHICLE_REG",
    "INTERNAL_HOSTNAME", "PRIVATE_IP", "FILE_PATH",
}
